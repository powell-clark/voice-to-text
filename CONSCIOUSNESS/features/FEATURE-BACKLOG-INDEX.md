...
FEAT-VTT036|p1|must-have|Keep the Homebrew tap current with the Rust macOS release — tap repo powell-clark/voice-to-text-homebrew (local ~/projects/aux/voice-to-text-homebrew) exists but is stale (Formula v0.2.0, Cask v0.3.16 file://); update Formula+Cask to the shipped release each time|STORY-VTT012||

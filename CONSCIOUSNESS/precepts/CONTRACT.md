...
R1. Work status must be: in-progress|in-review|blocked|done|cancelled|duplicate
R2. Feature status must be: in-progress|in-review
...
R16. FEATURES-DONE.md: id|location|tested|description [4 cols, NO status]

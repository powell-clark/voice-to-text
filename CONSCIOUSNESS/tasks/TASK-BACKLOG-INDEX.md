...
TASK-VTT075|p3|PGPS validation error wall is overwhelming for new users — needs friendlier guidance and auto-fix path — OPERATOR-DECISION-PENDING (upstream consciousness-plugin UX request, not fixable from this consumer repo; card confirms 2 of 3 criteria already done upstream)||||TASK-VTT075.md|||||a2||
TASK-VTT076|p3|Telemetry opt-in should be default at install — 30-day retention agreed at walkthrough, no opt-out required — OPERATOR-DECISION-PENDING (upstream consciousness-plugin installer/setup-wizard request, not controlled by this consumer repo)||||TASK-VTT076.md|||||b2b||

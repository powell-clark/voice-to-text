...
4. Binary verified to run push-to-talk dictation on the ARM64 tester's actual
   Snapdragon hardware (gensho — actual proof on the target machine).
5. The proprietary built-in stopgap is retired for the ARM64 tester.
